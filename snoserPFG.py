...
'buluevvladimir@gmail.com': 'mamadeda118',
'aria.therese.svensson@mail.com': 'Zorro1ab',
'onionov_bum@rambler.ru': 'Onionovbym2',
...
def logo():
    ...
    print("""
Hackes by Black Dolphin """)


def menu():
    print("1. Снос аккаунта телеграмм.")
    print("2. Снос телеграм канала [Снос канала кардиналов запрещен, система не будет отправлять письма связанные с данным каналом]")
    print("3. Канал автора")
    print("4. Снос телеграмм бота")
    choice = input("Раздел: ")
    return choice
...
def main():
    ...
    if choice == '1':
        ...
        print("4. СНОС СЕССИЙ.")
        print("5. С премкой")
        print("6. С виртуальным номером.")
        comp_choice = input("Раздел: ")
        ...
        print("1. Переходник на канал: @nation_ardan")
        print("2. Пока не придумали")
        bot_ch = input("Глава: @killCTPAX")

        if bot_ch == "1":
            bot_user = input("Юзернейм бота: ")
            print("Обработка...")
            comp_texts = {
